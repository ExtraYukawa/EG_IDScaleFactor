...
path_data="/eos/user/m/melu/Electron_SF/"
path="/eos/cms/store/group/phys_muon/balvarez/TnP_TopEFT_alternative_merged/"
...
for f in ["Tree_SingleElectron_Run2017B_0.root","Tree_SingleElectron_Run2017C_0.root","Tree_SingleElectron_Run2017D_0.root","Tree_SingleElectron_Run2017E_0.root","Tree_SingleElectron_Run2017E_1.root","Tree_SingleElectron_Run2017F_0.root","Tree_SingleElectron_Run2017F_1.root"]:
  SingleEG_names.push_back(path_data+f)

DY_name = ROOT.std.vector('string')()
for f in ["Tree_DYJetsToLL_M50_Electron2017_0.root","Tree_DYJetsToLL_M50_Electron2017_1.root","Tree_DYJetsToLL_M50_Electron2017_2.root","Tree_DYJetsToLL_M50_Electron2017_3.root","Tree_DYJetsToLL_M50_Electron2017_4.root"]:
...
def makehist(ptbin, etabin):
  ...
  filters_tag="Tag_pt > 37 && abs(Tag_eta) < 2.17 && Tag_mvaFall17V2Iso_WP90"
  filters_other="TnP_mass>60 && TnP_mass<120 && nElectron==2 && abs(Probe_eta)<2.5 && Probe_pt>10"
